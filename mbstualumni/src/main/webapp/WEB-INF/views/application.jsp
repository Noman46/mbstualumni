...
<body>
	...
	<div class="container">
		<form:form method="post" modelAttribute="applicationForm"
			action="/mbstualumni/sendApplication" class="form-horizontal"
			role="form">
			...
			<div class="form-group">
				<label for="fullName" class="col-sm-3 control-label">Full
					Name</label>
				<div class="col-sm-9">
					<form:input path="studentName" id="fullName"
			...
			<div class="form-group">
				<label for="motherName" class="col-sm-3 control-label">Mother's
					Name* </label>
				<div class="col-sm-9">
					<form:input path="motherName" id="motherName"
						placeholder="Mother's Name" class="form-control" name="moterName" />
				</div>
			</div>
			<div class="form-group">
				<label for="email" class="col-sm-3 control-label">Email* </label>
				<div class="col-sm-9">
					<form:input type="email" path="studentemail" id="email"
			...
			<div class="form-group">
				<label for="birthDate" class="col-sm-3 control-label">Date
					of Birth*</label>
				<div class="col-sm-9">
					<form:input type="date" path="studentDOB" id="birthDate"
						class="form-control" />
				</div>
			</div>
			<div class="form-group">
				<label for="hscBoard" class="col-sm-3 control-label">HSC
					Board:</label>
				<div class="col-sm-9">
					<form:select path="hscBoard"
						class="custom-select custom-select-lg mb-3" id="hscBoard">
			...
			<div class="form-group">
				<label for="hscRoll" class="col-sm-3 control-label">Hsc
					Roll* </label>
				<div class="col-sm-9">
			...
			<div class="form-group">
				<label for="session" class="col-sm-3 control-label">Session*
				</label>
				<div class="col-sm-9">
					<form:input path="versitySession" id="session"
						placeholder="2011-2012" class="form-control" name="session" />
				</div>
			</div>
			<div class="form-group">
				<label for="idNumber" class="col-sm-3 control-label">Id
					Number* </label>
				<div class="col-sm-9">
